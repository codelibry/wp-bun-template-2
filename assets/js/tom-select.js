...
!(function (e, t) {
				...
				for (const [t, s] of e)
					for (let e = t; e <= s; e++) {
						let t = String.fromCharCode(e),
							s = v(t);
						s != t.toLowerCase() &&
							(s.length > 3 || (0 != s.length && (yield { folded: s, composed: t, code_point: e })));
					}
			})(e))
			...
			return (
				...
				n.forEach((e) => {
					...
					o && (s = e.match(o)) && ((n = s[1]), (e = s[2])),
						...
						i.push({ string: e, regex: l ? new RegExp(l, 'iu') : null, field: n });
				}),
				i
			);
		}
	...
	const P = (e) => (null == e ? null : N(e)),
		...
		H = (e, t) =>
			!!t &&
			!!t[e] &&
			1 === (t.altKey ? 1 : 0) + (t.ctrlKey ? 1 : 0) + (t.shiftKey ? 1 : 0) + (t.metaKey ? 1 : 0),
		R = (e, t) => {
	...
	class ce extends (function (e) {
		...
		constructor(e, t) {
			...
			(i.tomselect = this),
				(s = (window.getComputedStyle && window.getComputedStyle(i, null)).getPropertyValue('direction'));
			const n = le(i, t);
			(this.settings = n),
				(this.input = i),
		...
		setup() {
			...
			se(n, { id: u }),
				se(c, { role: 'combobox', 'aria-haspopup': 'listbox', 'aria-expanded': 'false', 'aria-controls': u });
		...
		setupTemplates() {
			var e = this,
				...
				i = {
					...
					option_create: (e, t) =>
						'<div class="create">Add <strong>' + t(e.input) + '</strong>&hellip;</div>',
		...
		setActiveOption(e, t = !0) {
			e !== this.activeOption &&
				...
				e &&
					((this.activeOption = e),
					se(this.focus_node, { 'aria-activedescendant': e.getAttribute('id') }),
		...
		refreshOptions(e = !0) {
			...
			if (
				...
				if (m.items.length > 0) {
					if (
						(v || 'single' !== h.settings.mode || null == h.items[0] || (v = h.getOption(h.items[0])),
						!O.contains(v))
					) {
						let e = 0;
		...
		removeOptionGroup(e) {
			this.optgroups.hasOwnProperty(e) &&
				(delete this.optgroups[e], this.clearCache(), this.trigger('optgroup_remove', e));
		}
		clearOptionGroups() {
		...
		updateOption(e, t) {
			...
			const a = s.getOption(o),
				c = s.getItem(o);
			if (
				((t.$order = t.$order || l.$order), delete s.options[o], s.uncacheValue(r), (s.options[r] = t), a)
			) {
		...
		addItem(e, t) {
			V(this, t ? [] : ['change', 'dropdown_close'], () => {
				...
				if (
					(!r ||
						-1 === n.items.indexOf(r) ||
						('single' === o && n.close(), 'single' !== o && n.settings.duplicates)) &&
					null !== r &&
		...
		removeItem(e = null, t) {
			...
			(i = te(e)),
				e.remove(),
				e.classList.contains('active') &&
					((n = s.activeItems.indexOf(e)), s.activeItems.splice(n, 1), W(e, 'active')),
				s.items.splice(i, 1),
				(s.lastQuery = null),
		...
		deleteSelection(e) {
			...
			if (r.activeItems.length)
				(n = ee(r.activeItems, t)), (i = te(n)), t > 0 && i++, B(r.activeItems, (e) => l.push(e));
		...
		shouldDelete(e, t) {
			...
			return !(
				!s.length ||
				('function' == typeof this.settings.onDelete && !1 === this.settings.onDelete(s, t))
			);
		}
	...
	return (
		...
		ce.define('checkbox_options', function (e) {
			...
			const i = Object.assign(
				{ className: 'tomselect-checkbox', checkedClassNames: void 0, uncheckedClassNames: void 0 },
				e,
			);
			var n = function (e, t) {
					t
			...
			t.hook('after', 'setupTemplates', () => {
				...
				t.hook('instead', 'onOptionSelect', (e, i) => {
					if (i.classList.contains('selected'))
						return (
							i.classList.remove('selected'), t.removeItem(i.dataset.value), t.refreshOptions(), void q(e, !0)
						);
					s.call(t, e, i), o(i);
				});
		}),
		...
		ce.define('virtual_scroll', function () {
			...
			const c = (t) =>
					!('number' == typeof e.settings.maxOptions && n.children.length >= e.settings.maxOptions) &&
					!(!(t in r) || !r[t]),
			...
			(e.setNextUrl = (e, t) => {
				...
				e.hook('after', 'refreshOptions', () => {
					...
					c(t)
						...
						: t in r && !n.querySelector('.no-results') && (s = e.render('no_more_results', { query: t })),
